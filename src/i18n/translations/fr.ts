export const fr = {
  ...
  why: {
    eyebrow: 'Pourquoi choisir LUCEAT',
    heading: 'Des soins conçus pour la sensibilité de la peau de bébé',
    cards: {
      ...
      labExpertise: { title: 'Expertise de laboratoire', description: 'Des soins développés par un laboratoire dermo-cosmétique spécialisé.' },
