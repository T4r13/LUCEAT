    ...
    translations: {
      fr: {
        ...
        highlights: [
          ...
          { icon: 'shield-check', label: 'Hypoallergénique' },
          { icon: 'feather', label: 'Douceur naturelle' },
          { icon: 'shield-check', label: 'Film protecteur' },
      ...
      en: {
        ...
        highlights: [
          ...
          { icon: 'shield-check', label: 'Hypoallergenic' },
          { icon: 'feather', label: 'Natural gentleness' },
          { icon: 'shield-check', label: 'Protective film' },
    ...
    translations: {
      fr: {
        ...
        highlights: [
          ...
          { icon: 'flask-conical', label: 'Oxyde de zinc' },
          { icon: 'leaf', label: 'Calendula' },
      ...
      en: {
        ...
        highlights: [
          ...
          { icon: 'flask-conical', label: 'Zinc oxide' },
          { icon: 'leaf', label: 'Calendula' },
  ...
  },
  {
    ...
    translations: {
      fr: {
        ...
        description: "Le Lait de corps LUCEAT® hydrate et nourrit la peau des bébés et des enfants. Sa formule à base de cire d’abeille et d’huile d’amande douce hydrate les peaux les plus sèches et renforce la barrière naturelle cutanée. Elle pénètre rapidement et ne colle pas.",
        benefits: [
  ...
  },
  {
    ...
    translations: {
      ...
      en: {
        ...
        highlights: [
          { icon: 'shield-check', label: 'Purified scalp' },
    ...
    translations: {
      fr: {
        ...
        highlights: [
          { icon: 'feather', label: 'Douceur naturelle' },
          { icon: 'baby', label: 'Dès la naissance' },
          { icon: 'circle-off', label: '0 % huiles essentielles' },
      ...
      en: {
        ...
        highlights: [
          { icon: 'feather', label: 'Natural gentleness' },
          { icon: 'baby', label: 'From birth' },
          { icon: 'circle-off', label: '0% essential oils' },
